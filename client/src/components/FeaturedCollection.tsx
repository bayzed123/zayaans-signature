...
export default function FeaturedCollection() {
  ...
  if (loading) return <div className="mt-14 grid min-h-[280px] place-items-center border border-black/10 bg-[#ede8df]"><Loader2 className="animate-spin text-[#8f6b2c]" /></div>;
